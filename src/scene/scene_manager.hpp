...
#include "input_output/controller/keyboard_controller.hpp"
#include "input_output/controller/mouse_controller.hpp"
...
#include "objects/meshes/image.hpp"
...
namespace M3D
{
	class SceneManager : KeyboardController, MouseController
	{
	public:
		// --------------------------------------------- DESTRUCTOR / CONSTRUCTOR ----------------------------------------------
		SceneManager(const uint p_width, const uint p_height);
		~SceneManager();
