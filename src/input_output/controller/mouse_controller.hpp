	...
	public:
		...
		void receiveEvent(const SDL_Event& p_event) {
			...
			case SDL_EVENT_MOUSE_BUTTON_DOWN:
				...
				case SDL_BUTTON_LEFT: clearEvents(); _mouseLeftPressed = true; break;
				case SDL_BUTTON_RIGHT: clearEvents(); _mouseRightPressed = true; break;
				case SDL_BUTTON_MIDDLE: clearEvents(); _mouseMiddlePressed = true; break;
				default: break;
				}
				break;
