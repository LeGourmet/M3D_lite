...
namespace Renderer
{
	...
	RendererOGL::~RendererOGL() {
		...
		for (std::pair<Scene::Texture*, TextureOGL*> pair : _textures) delete pair.second;
	}
	...
	void RendererOGL::createTexture(Scene::Texture* p_texture) { _textures.insert(std::pair<Scene::Texture*, TextureOGL*>(p_texture, new TextureOGL(p_texture))); }
	...
	void RendererOGL::deleteTexture(Scene::Texture* p_texture) { delete _textures.at(p_texture); _textures.erase(_textures.find(p_texture)); }
}
}