...
namespace M3D
{
	namespace Renderer
	{
		class ObjectOGL : public Object
		{
		public:
			// --------------------------------------------- DESTRUCTOR / CONSTRUCTOR ----------------------------------------------
			ObjectOGL(const std::vector<Vertex> p_vertices, const std::vector<unsigned int> p_indices) {
		...
		private:
			...
			// ---------------------------------------------------- FONCTIONS ------------------------------------------------------
			void _bindValue(unsigned int p_id, unsigned int p_size, size_t offset){
